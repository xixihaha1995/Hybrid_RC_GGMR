...
from ..RC import _1_utils, _2_pyswarm
...
def train(_test_start = None, _end = None,  _n_particle = 2,_iters = 2,_case_nbr = 6, _ts = 300,_state_num = 6, _input_num = 9, _para_nums = 24 , parallel_computing = False, inspect_x_state = False):
    '''
    Use like:
    --------------------------------
...
if __name__ == "__main__":
    train(_test_start=4033, _n_particle=1000, _iters=150)