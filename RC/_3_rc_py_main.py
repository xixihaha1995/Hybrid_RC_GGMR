...
class RC_Class():
    ...
    def train(self,_test_start = None, _end = None,  _n_particle = 2,_iters = 2,_case_nbr = 6, _ts = 300,_state_num = 6, _input_num = 9, _para_nums = 24 , inspect_x_state = False):
        '''
        Use like:
        --------------------------------
    ...
    def visual_all(self, _test_start = None, _end = None,  _n_particle = 2,_iters = 2,_case_nbr = 6, _ts = 300,_state_num = 6, _input_num = 9, _para_nums = 24 ):
        swarm_constants = {}
